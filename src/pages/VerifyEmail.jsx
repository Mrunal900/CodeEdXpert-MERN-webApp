                ...
                <div className="lg:max-w-[500px] w-[90%] lg:my-auto my-16  p-4 bg-[#0000006a] rounded-2xl lg:p-8">
                    ...
                    <form onSubmit={handleVerifyAndSignup}>
                        ...
                        renderInput={(props) => (
                            ...
                            aspect-square text-center focus:border-0 focus:outline-2 focus:outline-[#7faaff]"
                            />
                        )}
                        containerStyle={{
                        ...
                        <button
                        type="submit"
                        className="w-full bg-[#7faaff] py-[12px] px-[12px] rounded-[8px] mt-6 font-medium text-richblack-900"
                        >
                        Verify Email
                        </button>
                    </form>
                    <div className="mt-6 flex items-center justify-between">
                        ...
                        <button
                        className="flex items-center text-[#7faaff] gap-x-2"
