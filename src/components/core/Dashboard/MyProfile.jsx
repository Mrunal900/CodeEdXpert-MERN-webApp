...
export default function MyProfile() {
  ...
  return (
    <div>
      ...
      <div className="flex items-center justify-between rounded-md  bg-[#242331] p-8 px-12">
      ...
      <div className="my-10 flex flex-col gap-y-10 rounded-md border-[1px] border-richblack-700 bg-[#242331] p-8 px-12">
